...
public class Item {
	...
	public double getPrestineValue() {
		...
		return Math.round(prestineValue);
	}

	public double getBaseVPW() {
		return Math.round(baseValue / weight);
	}

	public double getSaleVPW() {
		return Math.round(saleValue / weight);
	}

	public double getRuinedVPW() {
		return Math.round(ruinedValue / weight);
	}

	public double getPrestineVPW() {
		return Math.round(prestineValue / weight);
	}

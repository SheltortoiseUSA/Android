...
public class ProfessionalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contactList.add(new Contact("Osborn", R.drawable.male1));
        contactList.add(new Contact("Cornez", R.drawable.male1));
        contactList.add(new Contact("Peralta", R.drawable.male2));
        contactList.add(new Contact("Magedanz", R.drawable.male3));
